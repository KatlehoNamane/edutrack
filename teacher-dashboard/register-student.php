    ...
    <form method="POST" action="./scripts/register-student-script.php" class="space-y-4">
      ...
      <div>
        ...
        <button
          ...
          class="mt-2 bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600 transition"
        >Generate</button>
      </div>
      ...
      <div class="flex justify-between items-center">
        ...
        <?php if ($_SESSION['role'] === 'PRINCIPAL'): ?>
          <a href="principal_dashboard.php" class="text-blue-500 underline">Back to Dashboard</a>
        <?php else: /* TEACHER */ ?>
